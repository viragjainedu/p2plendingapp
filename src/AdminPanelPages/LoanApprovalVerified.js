...
class App extends Component {
  ...
  callAPI() {
    ...
    Axios.get("https://mysqlp2p.herokuapp.com0/borrowing/ProposedLoansForVerified", {
      }).then((response) => {
  ...
  handleButtonClickedReject(email) {
    ...
    //Axios ka post request daalna hai 
      Axios.post(`https://mysqlp2p.herokuapp.com0/borrowing/reject`, {
        email : email,
    }).then((response) => {
      console.log(response);
      // console.log("Hiiii")
  ...
  handleButtonClickedSendMail(email) {
    Axios.post(`https://mysqlp2p.herokuapp.com0/Mails/SendProposedLoansMail`, {
      email : email,
  }).then((response) => {
    console.log(response);
    if(response.data.success){
  ...
  handleButtonClickedCalculate(email) {
    Axios.post(`https://mysqlp2p.herokuapp.com0/borrowing/calculate`, {
      email : email,
  }).then((response) => {
    console.log(response);
  ...
  handleButtonClickedTransact(email,selected,rejected,amount) {
    ...
    Axios.post(`https://mysqlp2p.herokuapp.com0/borrowing/transact`, {
      email : email,
      selected : selected,
      rejected : rejected,
      amount : amount,
