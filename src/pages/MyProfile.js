...
class MyProfile extends Component {
  ...
  //   callAPI() {
  //       Axios.post("https://mysqlp2p.herokuapp.com0/p2pLending/isProfileComplete", {
  ...
  //       });
    ...
    if (password1 !== password2) {
        ...
        if( this.state.password1 !== ""      
            ...
            Axios.post("https://mysqlp2p.herokuapp.com0/myProfile/myProfilePassword", {               
    ...
    handleButtonClicked() {
          ...
          {
              //Axios ka post request daalna hai 
              Axios.post("https://mysqlp2p.herokuapp.com0/myProfile/myProfileUsername", {               
