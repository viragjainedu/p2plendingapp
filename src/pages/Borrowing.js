...
class App extends Component {
    ...
    constructor(props) {
     ...
     callAPI() {
        Axios.post("https://mysqlp2p.herokuapp.com0/borrowing/isProfileComplete", {
          ...
          if(response.data.result){
            if(response.data.result === true){
                this.setState({
                    ...
                    Axios.post("https://mysqlp2p.herokuapp.com0/borrowing/profile_info", {
                        email: localStorage.getItem('emailReg'),
                    }).then((response) => {
                      console.log(response);
                      if(response.data){
    ...
    getStatus() {
        Axios.post("https://mysqlp2p.herokuapp.com0/borrowing/getStatus", {
            email: localStorage.getItem('emailReg'),
        }).then((res)=>{
    ...
    isLoanCalculatedForThisEmail() {
        Axios.post("https://mysqlp2p.herokuapp.com0/borrowing/isLoanCalculatedForThisEmail", {
            email: localStorage.getItem('emailReg'),
        }).then((res)=>{
    ...
    isFicoCalculated() {
        Axios.post("https://mysqlp2p.herokuapp.com0/fico/isFicoCalculated", {
            email: localStorage.getItem('emailReg'),
        }).then((res)=>{
    ...
    handleButtonClicked() {
        ...
        if(this.state.emp_length !== "" &&  this.state.purpose !== "" &&  this.state.age !== "" &&  this.state.amount_req !== ""&&  this.state.month_req !== "" &&  this.state.collateral_value !== "" &&  this.state.collateral !== "" && this.state.contact !== "" && this.state.annual_income !== ""){
            ...
            //     })
                ...
                Axios.post("https://mysqlp2p.herokuapp.com0/borrowing/CompleteProfile", data).then((response) => {
                    console.log(response);
                    // console.log("Hiiii")
